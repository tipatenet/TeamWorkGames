...
Shader "Vefects/SH_Vefects_URP_VFX_Opaque_Fr_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Color;
			float4 _ColorFresnelBase;
			float4 _ColorFresnelEmissive;
			float4 _Noises01Selector;
			float2 _Noises01Speed;
			float2 _Noises01Scale;
			float _Fresnel02Bias;
			float _HueShift;
			float _LUTOffset;
			float _LUTAmplitude;
			float _LUTSpeed;
			...
			float _Desaturate;
			float _FresnelPower;
			float _Fresnel02Intensity;
			float _Fresnel02Power;
			float _Fresnel02Scale;
			float _Metallic;
			float _FresnelEmissiveMultiply;
			float _AlphaClip;
			float _Cutoff;
						 ...
						 ) : SV_Target
			{
				...
				float fresnelNdotV95 = dot( NormalWS, ViewDirWS );
				float fresnelNode95 = ( _FresnelBias + _FresnelScale * pow( max( 1.0 - fresnelNdotV95 , 0.0001 ), _FresnelPower ) );
				float fresnelNdotV103 = dot( NormalWS, ViewDirWS );
				float fresnelNode103 = ( _Fresnel02Bias + _Fresnel02Scale * pow( max( 1.0 - fresnelNdotV103 , 0.0001 ), _Fresnel02Power ) );
				float2 texCoord33 = input.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner46 = ( 1.0 * _Time.y * _Noises01Speed + ( texCoord33 * _Noises01Scale ));
				float dotResult56 = dot( tex2D( _NoisesTexture, panner46 ) , _Noises01Selector );
				float2 texCoord113 = input.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 BaseColor = lerpResult25;
				float3 Normal = float3(0, 0, 1);
				float3 Specular = 0.5;
				float Metallic = _Metallic;
				float Smoothness = _Smoothness;
				float Occlusion = 1;
				float3 Emission = ( staticSwitch62 * ( temp_output_64_0 * _FresnelEmissiveMultiply ) ).rgb;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float fresnelNode103 = ( _Fresnel02Bias + _Fresnel02Scale * pow( max( 1.0 - fresnelNdotV103 , 0.0001 ), _Fresnel02Power ) );
				float2 texCoord33 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner46 = ( 1.0 * _Time.y * _Noises01Speed + ( texCoord33 * _Noises01Scale ));
				float dotResult56 = dot( tex2D( _NoisesTexture, panner46 ) , _Noises01Selector );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 panner46 = ( 1.0 * _Time.y * _Noises01Speed + ( texCoord33 * _Noises01Scale ));
				float dotResult56 = dot( tex2D( _NoisesTexture, panner46 ) , _Noises01Selector );
				float2 texCoord113 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult114 = smoothstep( 0.5 , ( 0.5 + 0.5 ) , ( ( texCoord113.y * ( 1.0 - texCoord113.y ) ) * 4.0 ));
				float temp_output_64_0 = saturate( ( saturate( ( saturate( fresnelNode95 ) * _FresnelIntensity ) ) + saturate( ( saturate( ( saturate( fresnelNode103 ) * _Fresnel02Intensity ) ) * saturate( ( saturate( dotResult56 ) * saturate( smoothstepResult114 ) ) ) ) ) ) );
				float3 lerpResult25 = lerp( _Color.rgb , _ColorFresnelBase.rgb , temp_output_64_0);
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;63;-768,0;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;132;0,100;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;14;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;133;0,100;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;XRMotionVectors;0;11;XRMotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;14;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;True;1;False;;255;False;;1;False;;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;False;True;1;LightMode=XRMotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=1A8D5831CF6613DA2135116BB10754B9500D119F